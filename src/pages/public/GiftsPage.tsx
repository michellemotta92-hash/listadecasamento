...
export default function GiftsPage() {
  ...
  return (
    <div className="space-y-12">
      ...
      >
        <p className="text-xs uppercase tracking-[0.3em] text-[#a89e95] font-medium">Nossa lista</p>
        ...
        <p className="text-[#8a7e76] max-w-xl mx-auto leading-relaxed font-light text-lg">
          Montamos nossa casa com muito carinho. Se desejar nos presentear,
          escolhemos alguns itens que adoraríamos ter.
        </p>
      </motion.div>
